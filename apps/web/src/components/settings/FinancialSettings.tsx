      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col h-full">
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Configure currency, tax rates, and financial goals.</p>
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Applied to applicable transactions automatically.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
