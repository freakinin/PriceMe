      ...
      >
        ...
        >
          <div
            ...
            style={{ backgroundColor: 'hsl(220 13% 10%)', color: 'hsl(0 0% 98%)' }}
          >
            {children}
          </div>
        </div>
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground",
